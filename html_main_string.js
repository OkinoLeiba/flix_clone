...
</div></div></section>--><!--["movie-title-thumbnail-vscroll-container] Section Created with JavaScript--><!--<div\
 id="movie-title-thumbnail-vscroll-container"></div> --></input>';
...
export default class CreateBodyString {
    ...
    document.body.append(createBody());
    ...
    document.body.appendChild(domParse);
