...
createBody = () => {
    ...
    navBanner.setAttribute("id", id = "top-desktop-nav");
    document.getElementById("top-top-section-banner-container").append(navBanner);

    // create element in nav bar
    ...
    document.getElementById('top-nav-icon-link-logo').after(navH1Tag);
    ...
    leftSidePanelMenu.setAttribute("left-side-menu");
    document.getElementById().appendChild(leftSidePanelMenu);
    ...
    titleButtonContainer.setAttribute("id", id = "title_button-container");
    document.getElementById("top-center-full-banner-image").after(titleButtonContainer);
        ...
        document.createElement("title_button-container").appendChild(titleHeaderBanner);
        ...
        document.getElementById("banner-button-tl").after(buttonTL);
